...
Backup Solution for cloning a Live Debian or Ubuntu Server to a bootable ".img" file. Based off of the set of bash scripts called "Image File Utilities" (https://forums.raspberrypi.com/viewtopic.php?t=332000#p1511694) created by RonR (https://forums.raspberrypi.com/memberlist.php?mode=viewprofile&u=186692&sid=b8ad4e175a4d6ab7ca3652e03de8ad49) in the Raspberry Pi Forums (https://forums.raspberrypi.com/). The original set of scripts can be downloaded from https://forums.raspberrypi.com/download/file.php?id=74592
